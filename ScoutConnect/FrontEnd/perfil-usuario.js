...
if (nombreUsuario) {
    document.getElementById("nombre-perfil").value = nombreUsuario;
} //+
...
if (perfilGuardado && formularioPerfil) {document.getElementById("nombre-perfil").value = perfilGuardado.nombre || "";
    document.getElementById("rut-perfil").value = perfilGuardado.rut || "";
    document.getElementById("telefono-perfil").value = perfilGuardado.telefono || "";
    document.getElementById("fecha-nacimiento").value = perfilGuardado.fechaNacimiento || "";
    document.getElementById("comuna-perfil").value = perfilGuardado.comuna || "";
    document.getElementById("direccion-perfil").value = perfilGuardado.direccion || "";
    document.getElementById("grupo-perfil").value = perfilGuardado.grupo || "";
}
// Guardar información
if (formularioPerfil) {
